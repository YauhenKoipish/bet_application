...
class GoalsOddEven extends React.Component {
    constructor(props) {
        super(props);
        ...
        this.initialState = {
            ...
            event: props.event,
            dict: props.dictionary.goalsOddEven,
        ...
        dictObj.ids.forEach(elem => {
            ...
            if (line) {
                if (tabInfo.activeMarket.length === 0) {
                    ...
                    tabInfo.outcomeId =
                        state.dictOutcome[
                            this.props.reName(market.outcomeName[0])
                        ];
                }
            }
        });
    ...
    createOutcomeList(event, state) {
        ...
        if (state.addClassActive.activeTab === 0) {
            outcomeList.set("even", this.props.lang.even);
            outcomeList.set("odd", this.props.lang.odd);
            ...
            if (linesMarkets.length === 0) {
                ...
                if (
                    ...
                    if (
                        ...
                        newState.tabInfo = this.tabList(
                            this.props.dictionary.goalsOddEven,
                            props.newEvents.get(this.props.event.id),
                            newState
                        );
