...
import { DropdownHandicap } from "./Dropdown";
import Coef from "./Coef";

export default class LineHandicap extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    if (window.debugLine === event.id) debugger;
...
export const getLinesHandicap = (event, getLineType) => {
